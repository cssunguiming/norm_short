...
def main(Epoch=400, Bert_Pretrain=False, Pretrained=False, Batch_size=10, log=None):
    ...
    if Bert_Pretrain:
        ...
        Bert = Bert_Traj_Model(token_size=len(dataset_4qs['vid_list']), head_n=10, d_model=500, N_layers=10, dropout=0.3)
    ...
    model = Predict_Model(Bert, token_size=len(dataset_4qs['vid_list']), head_n=10, d_model=500, N_layers=10, dropout=0.3) 
    if Pretrained:
